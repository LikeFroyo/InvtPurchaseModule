page 50100 "PurchaseReqstGADeptList"
{
    Caption = 'GA Purchase Requisition List';
    Description = 'GA Purchase Requisition List Page';
    ...
    SourceTableView = where("No." = filter('GA*'), "Document Type" = filter(Quote));
    ...
    begin
        ...
        PurchaseAndPayableSetup."Quote Nos." := 'GA-DE-PR';

page 50102 "PurchaseReqstCSDeptList"
{
    Caption = 'CS Purchase Requisition List';
    Description = 'CS Purchase Requisition List Page';
    ...
    SourceTableView = where("No." = filter('CS*'), "Document Type" = filter(Quote));
    ...
    begin
        ...
        PurchaseAndPayableSetup."Quote Nos." := 'CS-DE-PR';

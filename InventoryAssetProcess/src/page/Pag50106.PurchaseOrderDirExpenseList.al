page 50106 "PurchaseOrderDirExpenseList"
{
    Caption = 'Direct Expense Purchase Order List';
    Description = 'Direct Expense Purchase Order List Page';
    ...
    Editable = false;
    SourceTableView = where("Order Type" = filter('Direct Expense'), "Document Type" = filter(Order));

page 50110 "PurchaseInvoiceInvAssetList"
{
    Caption = 'Inventory Asset Purchase Invoice List';
    Description = 'Inventory Asset Purchase Invoice List Page';
    ...
    Editable = false;
    SourceTableView = where("Order Type" = filter('Inventory Asset'), "Document Type" = filter(Invoice));
